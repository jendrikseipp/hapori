...
PLANNERS = [
    ...
    (80, ['ipc2018-fd-2018', 'config22']),
    # ipc2018-fd-2018:config46
    (40, ['ipc2018-fd-2018', 'config46']),
    # ipc2018-fd-2018:config44
    (38, ['ipc2018-fd-2018', 'config44']),
    # ipc2018-fd-2018:config10
    (37, ['ipc2018-fd-2018', 'config10']),
    # ipc2018-fd-2018:config17
    (39, ['ipc2018-fd-2018', 'config17']),
    # ipc2018-fd-2018:config59
    (36, ['ipc2018-fd-2018', 'config59']),
    # ipc2018-fd-2018:config53
    (40, ['ipc2018-fd-2018', 'config53']),
    # ipc2018-fd-2018:config05
    (24, ['ipc2018-fd-2018', 'config05']),
