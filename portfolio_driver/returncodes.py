...
SUCCESS = 0
PLANNER_PLAN_FOUND_AND_OUT_OF_MEMORY = 1
PLANNER_PLAN_FOUND_AND_OUT_OF_TIME = 2
PLANNER_PLAN_FOUND_AND_OUT_OF_MEMORY_AND_TIME = 3

PLANNER_OUT_OF_MEMORY = 22
PLANNER_OUT_OF_TIME = 23
PLANNER_OUT_OF_MEMORY_AND_TIME = 24
...
### runlim propagates run.py return codes, which is 0 or 99
HAPORI_UNKNOWN = 99
...
def generate_portfolio_exitcode(exitcodes):
    ...
    if SUCCESS in exitcodes:
        if OUT_OF_MEMORY in exitcodes and OUT_OF_TIME in exitcodes:
            return PLANNER_PLAN_FOUND_AND_OUT_OF_MEMORY_AND_TIME
        elif OUT_OF_MEMORY in exitcodes:
            return PLANNER_PLAN_FOUND_AND_OUT_OF_MEMORY
        elif OUT_OF_TIME in exitcodes:
            return PLANNER_PLAN_FOUND_AND_OUT_OF_TIME
        else:
            return SUCCESS

    # No plan was found due to hitting resource limits.
    if OUT_OF_MEMORY in exitcodes and OUT_OF_TIME in exitcodes:
        return PLANNER_OUT_OF_MEMORY_AND_TIME
    elif OUT_OF_MEMORY in exitcodes:
        return PLANNER_OUT_OF_MEMORY
    elif OUT_OF_TIME in exitcodes:
        return PLANNER_OUT_OF_TIME
