...
def main():
    ...
    pddlFile.dumpSimply()
    pddlFile.printObject(scriptpath+"/translateFile")
    pddlFile.printObjectSimply(scriptpath+"/translateFileSimply")
    pddlFile.dump()
    ...
    with timers.timing("Writing output"):
        with open(scriptpath +"/output.sas", "w") as output_file:
