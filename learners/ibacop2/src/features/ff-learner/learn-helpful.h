...
#define STR_PRED_ACHIEVEDGOAL "achieved"
#define STR_PRED_STATIC_FACT "static_fact"
#define STR_PRED_STATE "state"
#define STR_PRED_RPADD "rpadd"
#define STR_PRED_RPDEL "rpdel"
...
#define PRED_NOTHELPFUL 4
#define PRED_RPACTION 5
#define PRED_EXECUTED 6
