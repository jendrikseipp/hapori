...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0009) (guarded location-0015) (guarded location-0028) (guarded location-0050) (guarded location-0053) (guarded location-0054) (guarded location-0056) (guarded location-0057))
