(define (problem recharge-single-source-move-to-locations-3636) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
  ...
  (connected location-0017 location-0023)
  ...
  (at robot-03 location-0018)
  (battery robot-03 battery-0002)
)
(:goal (and (at robot-00 location-0012) (at robot-01 location-0011) (at robot-02 location-0034) (at robot-03 location-0002)))
