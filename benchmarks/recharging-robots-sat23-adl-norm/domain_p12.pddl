...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0003) (guarded location-0005) (guarded location-0006) (guarded location-0011) (guarded location-0014) (guarded location-0015) (guarded location-0030) (guarded location-0032) (guarded location-0033))
...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0005) (guarded location-0008) (guarded location-0011) (guarded location-0012) (guarded location-0014) (guarded location-0018) (guarded location-0030) (guarded location-0047) (guarded location-0048) (guarded location-0049) (guarded location-0058) (guarded location-0059) (guarded location-0060) (guarded location-0061))
