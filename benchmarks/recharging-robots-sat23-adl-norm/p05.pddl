(define (problem recharge-single-source-move-to-locations-6440) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
  ...
  (connected location-0017 location-0021)
  ...
  (connected location-0016 location-0040)
  ...
  (connected location-0021 location-0048)
  ...
  (connected location-0027 location-0029)
  ...
  (connected location-0029 location-0049)
  ...
  (connected location-0011 location-0045)
  ...
  (connected location-0037 location-0039)
  (connected location-0030 location-0033)
  (connected location-0027 location-0046)
  ...
  (connected location-0009 location-0034)
  (connected location-0002 location-0028)
  (connected location-0006 location-0010)
  (connected location-0032 location-0047)
  (connected location-0033 location-0046)
  ...
  (connected location-0019 location-0037)
  (connected location-0011 location-0042)
  (connected location-0001 location-0034)
  ...
  (connected location-0005 location-0031)
  (connected location-0019 location-0030)
  (connected location-0028 location-0042)
  (connected location-0011 location-0035)
  ...
  (connected location-0015 location-0044)
  (connected location-0008 location-0014)
  (connected location-0040 location-0046)
  ...
  (at robot-03 location-0014)
  (battery robot-03 battery-0003)
  (at robot-04 location-0020)
  (battery robot-04 battery-0015)
  (at robot-05 location-0020)
  (battery robot-05 battery-0002)
)
(:goal (and (at robot-00 location-0035) (at robot-01 location-0038) (at robot-02 location-0036) (at robot-03 location-0044) (at robot-04 location-0022) (at robot-05 location-0003)))
