(define (problem recharging-robots-cover-robots2-areas3-1283-1948) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
  ...
  (guard-config config-02 location-0003)
  (guard-config config-02 location-0004)
  (guard-config config-02 location-0007)
  (guard-config config-02 location-0015)
  (guard-config config-02 location-0017)
  (guard-config config-02 location-0019)
  (guard-config config-02 location-0021)
  (guard-config config-02 location-0054)
  (guard-config config-02 location-0055)
  (guard-config config-02 location-0056)
)
