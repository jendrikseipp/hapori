(define (problem recharge-single-source-move-to-locations-2356) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
  ...
  (connected location-0006 location-0035)
  ...
  (at robot-00 location-0038)
  (battery robot-00 battery-0009)
  (at robot-01 location-0002)
  (battery robot-01 battery-0006)
  (at robot-02 location-0017)
  (battery robot-02 battery-0004)
  (at robot-03 location-0034)
  (battery robot-03 battery-0001)
)
(:goal (and (at robot-00 location-0017) (at robot-01 location-0012) (at robot-02 location-0030) (at robot-03 location-0016)))
