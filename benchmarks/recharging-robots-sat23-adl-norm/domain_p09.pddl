...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0002) (guarded location-0004) (guarded location-0006) (guarded location-0009) (guarded location-0010) (guarded location-0011) (guarded location-0012) (guarded location-0013) (guarded location-0018) (guarded location-0021))
