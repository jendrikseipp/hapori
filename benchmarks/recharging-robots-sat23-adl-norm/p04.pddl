(define (problem recharge-single-source-move-to-locations-8449) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
  ...
  (connected location-0029 location-0034)
  ...
  (connected location-0008 location-0031)
  ...
  (connected location-0015 location-0031)
  ...
  (at robot-03 location-0031)
  (battery robot-03 battery-0004)
  (at robot-04 location-0024)
  (battery robot-04 battery-0005)
)
(:goal (and (at robot-00 location-0010) (at robot-01 location-0030) (at robot-02 location-0018) (at robot-03 location-0002) (at robot-04 location-0012)))
