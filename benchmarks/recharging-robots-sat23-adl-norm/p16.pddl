(define (problem recharging-robots-cover-robots4-areas2-1321-9679) (:domain recharging-robots)
(:init
  (= (move-cost) 1)
  (= (recharge-cost) 1)
  (= (total-cost) 0)
