...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0007) (guarded location-0011) (guarded location-0019) (guarded location-0022) (guarded location-0031) (guarded location-0032) (guarded location-0033) (guarded location-0059))
...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0002) (guarded location-0005) (guarded location-0009) (guarded location-0016) (guarded location-0026) (guarded location-0039) (guarded location-0050) (guarded location-0051))
