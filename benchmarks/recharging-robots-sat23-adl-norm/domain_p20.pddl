...
(:constants
    ...
    battery-0044 - battery-level
    battery-0045 - battery-level
    config-00 - config
    config-01 - config
)
(:predicates
...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0001) (guarded location-0004) (guarded location-0007) (guarded location-0008) (guarded location-0012) (guarded location-0014) (guarded location-0016) (guarded location-0019) (guarded location-0021) (guarded location-0024) (guarded location-0025) (guarded location-0028) (guarded location-0030) (guarded location-0031) (guarded location-0032) (guarded location-0033) (guarded location-0050) (guarded location-0051) (guarded location-0052) (guarded location-0053) (guarded location-0054) (guarded location-0055) (guarded location-0056) (guarded location-0057) (guarded location-0069))
