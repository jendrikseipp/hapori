...
(:action verify-guard-config
    :parameters (?c - config)
    :precondition (and (= ?c config-00) (guarded location-0004) (guarded location-0018) (guarded location-0019) (guarded location-0034) (guarded location-0035) (guarded location-0036) (guarded location-0037) (guarded location-0050) (guarded location-0052) (guarded location-0053))
...
(:action verify-guard-config-dup-1
    :parameters (?c - config)
    :precondition (and (= ?c config-01) (guarded location-0005) (guarded location-0008) (guarded location-0011) (guarded location-0013) (guarded location-0016) (guarded location-0022) (guarded location-0026) (guarded location-0027) (guarded location-0056))
