(define (problem sliterlink-146453) (:domain slitherlink)
(:init
  ...
  (cell-capacity cell-8-5 cap-3)
  (cell-capacity cell-8-6 cap-4)
  (cell-capacity cell-8-7 cap-2)
  (cell-capacity cell-8-8 cap-2)
