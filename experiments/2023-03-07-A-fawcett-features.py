...
DIR_FEATURE_EXTRACTOR = os.environ["FAWCETT_FEATURE_EXTRACTOR"]
...
for task in suites.build_suite(BENCHMARKS_DIR, SUITE):
    ...
    run.add_command(
        "extract_features",
        ["{feature_extractor}/extract_planning_features.py",
         "--domain-file", "{domain}",
...
exp.add_report(CollectFeaturesReport(
    ...
    directory_name="features.json",
    is_json=True), outfile="annotated_graphs")
