...
static const char *opt_heur_mgroup_merge[] = {
    "cp", "max", NULL
};
...
static optdef_t opt_heur[] = {
    ...
    { "max2", opt_heur_all },
    { "lm-cut", opt_heur_all },
    { "relax-lm-cut", opt_heur_all },
    { "lm-cut-inc-local", opt_heur_all },
    { "relax-lm-cut-inc-local", opt_heur_all },
    { "lm-cut-inc-cache", opt_heur_lm_cut_inc_cache },
    { "relax-lm-cut-inc-cache", opt_heur_lm_cut_inc_cache },
    { "lm-cut2", opt_heur_all },
    { "flow", opt_heur_flow },
    { "flow-mgroup-ldm", opt_heur_flow },
    { "pot", opt_heur_pot },
    { "ma-max", opt_empty },
    { "ma-ff", opt_empty },
    { "ma-lm-cut", opt_empty },
    ...
    { "ma-pot-proj", opt_heur_ma_pot_proj },
    { "mgroup-merge", opt_heur_mgroup_merge },
};
...
"        goalcount, add, max, ff, dtg, max2, lm-cut, lm-cut-inc-local, lm-cut2,\n"
...
options_t *options(int argc, char *argv[])
{
    ...
    if (o->proto == NULL
            && o->fd == NULL
            && (o->domain_fn == NULL || o->problem_fn == NULL)){
