...
class Conjunction(JunctorCondition):
    ...
    def pddl_str(self):
        return '(and\n\t  ' + '\n\t  '.join([part.pddl_str() for part in self.parts]) + ')\n'
...
class Disjunction(JunctorCondition):
    ...
    def has_disjunction(self):
        return True
    def pddl_str(self):
        return '(or ' + ' '.join([part.pddl_str() for part in self.parts]) + ')\n'
...
class UniversalCondition(QuantifiedCondition):
    ...
    def has_universal_part(self):
        return True
    def pddl_str(self):
        return 'forall ' + ' '.join([part.pddl_str() for part in self.parts]) + '\n'
...
class ExistentialCondition(QuantifiedCondition):
    ...
    def has_existential_part(self):
        return True
    def pddl_str(self):
        return 'exists ' + ' '.join([part.pddl_str() for part in self.parts]) + '\n'
...
class Literal(Condition):
    ...
    def pddl_str(self):
        return '(%s) %s' % (self.predicate.pddl_str(), ' '.join([arg.pddl_str() for arg in self.args]))
    def __repr__(self):
        return '<%s>' % self
    def _dump(self):
        return str(self)
