...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 3:
        ...
        domain_ready  	 	  = workingdir + "/domain_ready.pddl"
        problem_ready 	 	  = workingdir + "/problem_ready.pddl"
    ...
    if(numMaxOfWhenPerAction == 0):	# No hay efectos condicionales
        ...
        name = adl_2_strips + " -o " + domain_wac + " -f " + problem_wac + " -s " + workingdir  + "/ -B"
        data = os.system(name)
        ...
        name = adl_2_strips + " -o " + domain_wac + " -f " + problem_wac + " -s " + workingdir + "/"
        data = os.system(name)
