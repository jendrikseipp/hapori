#include "first_fit_increasing_related_bin_packer.h"
...
FirstFitIncreasingRelatedBinPacker::FirstFitIncreasingRelatedBinPacker(double pdb_size, int num_collections) :
        pdb_max_size (pdb_size),
        num_pbd_collections (num_collections) {
}

vector<Pattern> FirstFitIncreasingRelatedBinPacker::bin_packing(std::shared_ptr<TaskProxy> task_proxy) {
