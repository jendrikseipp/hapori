...
""" !!!!!!!!!!!!!!!!!!!!! STOP !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    This file is big and messy and deals with the translation from .fd_pddl (with ADL)
...
class ForAllCondition(Condition):
    ...
    def make_flat_effects(self, ground_effects, grounding):
        ...
        """
        for cgrounding in self.ground_conditions[grounding].values():
...
class Problem(object):
    ...
    def make_cond_and_cond_eff_lists(self):
        """ Make seperate lists of conditions and conditional effects that will
            ...
            (Problem) -> None
        """
        for cond in self.code_conds.values():
    ...
    def compute_conflict_mutex(self):
        ...
        for action1 in self.actions.values():
    ...
    def make_strips_problem(self):
        ...
        for (predicate, grounding), prop in neg_propositions.items():
            #Effects
        ...
        if self.first_layer_actions is not None:
            ...
            for action, step in self.first_layer_actions.items():
        ...
        if self.state_mutexes is not None:
            ...
            for step, mutexes in self.state_mutexes.items():
