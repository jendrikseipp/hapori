...
def parse_arguments(args):
	...
	parser.add_argument('--install', action='store_true', default="False", help="Install the module after compilation.")
	return parser.parse_args(args)

def single_build(directory, command):
	# Build the lapkt-novelty library
	print('\nBuilding "lapkt-novelty"...')
	sys.stdout.flush()
