...
#define PREDICATETYPE_NOTHELPFUL 4
#define PREDICATETYPE_RPACTION 5
#define PREDICATETYPE_STATE 6
#define PREDICATETYPE_ACHIEVEDGOAL 7
#define PREDICATETYPE_RPADD 8
#define PREDICATETYPE_RPDEL 9
#define PREDICATETYPE_LANDMARK 10
#define PREDICATETYPE_NEXT 11

#define PREDICATETYPE_GOAL 12
#define PREDICATETYPE_INIT 13

#define PREDICATETYPE_DERIVED 20
...
typedef struct _LTnode {
  ...
  int type; /* 0: helpful, 1:target-goal, 2:static, 3: executed, -1:
	       finish, -2: tag */
  ...
  LTmatch *matches;
  LTmatch *partial_matches; /* pre-computing the bindings of each predicate type for efficiency reasons*/
  Bool tag_bounded;
  /* father */
...
int LT_last_executed_index;
int LT_current_num_RP;
int *LT_current_RP;

LTproposal *selected_proposal;

Bool landmarks_computed;
