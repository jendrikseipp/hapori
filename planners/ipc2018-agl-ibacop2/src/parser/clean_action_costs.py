...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 3:
        ...
        ##old route without image
        scriptOutput = os.path.abspath(sys.argv[1])
        scriptpath = os.path.abspath(scriptOutput)
        lista = scriptpath.split("/")[:-1]
        name = '/'.join(lista) 
        print name
        ...
        modified_domain   	  = name + "/domain_without_action_costs.txt"
        modified_problem  	  = name + "/problem_without_action_costs.txt"
        action_costs_domain_file  = name + "/action_costs_from_domain_file.txt"
        action_costs_problem_file = name + "/action_costs_from_problem_file.txt"
