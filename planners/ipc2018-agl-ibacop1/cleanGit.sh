...
git rm -f cavediving-domain.pddl
git rm -f citycar_domain.pddl
git rm -f downward.tmp.29708
...
git rm -f p1-cavediving.pddl
git rm -f p1-citycar.pddl
git rm -f p1-parc.pddl
git rm -f p1-researches.pddl
git rm -f p1-sokoban.pddl
git rm -f parc-domain.pddl
git rm -f plan_numbers_and_cost
git rm -f red-black
git rm -f researchers-domain.pddl
git rm -f sokoban-domain.pddl
...
git rm -f src/translate-old/*.pyc
git rm -f src/translate-old/pddl/*.pyc
...
got rm -f src/translate-old/*.pyc
git rm -f src/translate/pddl/*.pyc
git rm -f src/features/ff-learner/initfeature-info.txt
git rm -f src/features/preprocess/features.arff
git rm -f src/features/preprocess/featuresGraph
git rm -f src/features/preprocess/featuresSimply.arff
git rm -f src/parser/VAL-4.2.08/src/main.cpp~
git rm -f src/translate/axiom_rules.pyc
git rm -f src/translate/build_model.pyc
git rm -f src/translate/constraints.pyc
git rm -f src/translate/fact_groups.pyc
...
git rm -f src/translate/timers.pyc
git rm -f src/translate/tools.pyc
git rm -f src/yahsp2-mt/src/gdsl/config.h.in~
git rm -f src/search-mercury/.obj/*.o
git rm -f src/search-mercury/.obj/landmarks/*.o
git rm -f src/search-mercury/.obj/open_lists/*.o
git rm -f src/search-mercury/.obj/graph_algorithms/*.o
git rm -f src/search-mercury/.obj/red_black/*.o

git add src/search-mercury/.obj/
git add src/search-mercury/.obj/landmarks/
git add src/search-mercury/.obj/open_lists/
git add  src/search-mercury/.obj/graph_algorithms/*.o
git add src/search-mercury/.obj/red_black


git add src/launcher/solve.py
git rm -f src/launcher/systools.pyc
git rm -f src/launcher/timetools.pyc
git add src/parser/clean_action_costs.py
git add src/parser/clean_plans.py
git add src/parser/parse.py
...
git rm -f src/features/translate/*.pyc
git rm -f src/features/translate/pddl/*.pyc
git rm -f src/features/preprocess/.obj/*.o 
git rm src/features/heuristics/translate/*.pyc -f
git rm -f src/features/ff-learner/*.o 
...
git add src/parser/restore_action_costs.py
git add src/translate/translate.py
git add src/launcher/portfolio.py
