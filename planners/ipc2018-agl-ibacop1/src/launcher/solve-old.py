...
if __name__ == '__main__':
    ...
    try:
        if(original_data):
            ...
            print "Run command: " + str(command)
            os.system(command)
            command =  "ulimit -v 4194304;ulimit -t 50; " + rootpath + "/features/preprocess/preprocess < output.sas"
            print "Run command: " + str(command)
            os.system(command)
            ...
            command = "python2.7 "+ actual_rootpath + "/joinFile.py " + rootpath[:rootpath.rfind("/")]
            print "Run command: " + str(command)
            os.system(command)
        else:
        ...
        command = "java -cp "+ rootpath +"/models/weka.jar -Xmx2048M weka.filters.unsupervised.attribute.Remove -R 1-3,20,65,78-79,82-83,92 -i global_features.arff -o global_features_simply.arff"
        print "Run command: " + str(command)
        os.system(command)
