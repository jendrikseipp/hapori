...
void DtgOperators::clear_sufficient() {
	...
	if (-1 != goal_val) {
#ifdef DEBUG_RED_BLACK
		cout << "[RedSufficient Goal]: [" <<g_fact_names[var][goal_val] << "]" << endl;
#endif
...
void DtgOperators::mark_as_sufficient(int val) {
	...
	number_sufficient_unachieved_vals++;
#ifdef DEBUG_RED_BLACK
	cout << "[RedSufficient]: [" <<g_fact_names[var][val] << "]" << endl;
#endif
}
...
#ifdef DEBUG_RED_BLACK
	cout << "Reachable black value " << g_fact_names[var][val] << endl;
#endif
...
#ifdef DEBUG_RED_BLACK
	cout << "Reachability status for " << g_fact_names[var][val] << " is " << reachable_black_vals[val] << endl;
#endif
...
#ifdef DEBUG_RED_BLACK
	cout << "Marking value: " << g_fact_names[var][val] << " for " << (is_black ? "black" : "red") << " variable" << endl;
#endif
...
#ifdef DEBUG_RED_BLACK
	cout << "Marked achieved value: " << g_fact_names[var][val] << ", missing value: " << missing_value << endl;
#endif
	return true;
}
...
void DtgOperators::mark_missing_val(int val) {
	...
	missing_value = val;
#ifdef DEBUG_RED_BLACK
	cout << "Marked missing value: " << g_fact_names[var][val] << ": " << val << endl;
#endif
}
