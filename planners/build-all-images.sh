...
./build-image.sh ../planners/ipc2018-opt-decstar/Singularity ${OUTDIR}/ipc2018-opt-decstar.img || true  # finds no factoring
...
#./build-image.sh ../planners/ipc2018-agl-ibacop1/Singularity ${OUTDIR}/ipc2018-agl-ibacop.img
